...
func randFieldTags(dAtA []byte, r randyTags, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateTags(dAtA, uint64(v5))
	case 1:
		dAtA = encodeVarintPopulateTags(dAtA, uint64(key))
...
var fileDescriptorTags = []byte{
	...
	0x69, 0x60, 0x1e, 0x98, 0x03, 0x66, 0x41, 0x34, 0x29, 0x4d, 0x62, 0xe4, 0x62, 0xf7, 0x2f, 0x2d,
	...
	0xf2, 0x2c, 0x89, 0x25, 0x25, 0x45, 0x41, 0x08, 0x29, 0x25, 0x4b, 0x2e, 0x74, 0x2b, 0x0c, 0xc1,
	0x4e, 0x42, 0xb5, 0xc2, 0x10, 0x62, 0x45, 0x5e, 0x09, 0xc2, 0x0a, 0x43, 0x27, 0x96, 0x1f, 0x0f,
	0xe5, 0x18, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x37, 0x6d, 0x7e, 0x76, 0x17, 0x01, 0x00, 0x00,
}
